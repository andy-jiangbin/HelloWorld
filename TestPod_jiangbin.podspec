...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/andy-jiangbin/HelloWorld"
  ...
  spec.author             = { "jiangbin" => "253200746@qq.com" }
  # Or just: spec.author    = ""
  # spec.authors            = { "" => "" }
  ...
  spec.source       = { :git => "https://github.com/andy-jiangbin/HelloWorld.git", :tag => "#{spec.version}" }
  ...
  ss.public_header_files = 'Tools/*.h'
  end
